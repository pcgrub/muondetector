...
def write_hist_file(bins, n):
    bin_size = (bins[1]-bins[0])
    bin_mid = bins[1:] - 0.5*bin_size
    output = np.column_stack((bins[:-1], bins[1:], bin_mid, n))
    np.savetxt("/home/piet/Dokumente/myon-detector/utils/energy_calibration/conc_energy_cali.csv",
               output, delimiter=",", fmt="%7.7f", newline="\n")
